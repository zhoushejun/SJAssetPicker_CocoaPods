...
Pod::Spec.new do |s|
  s.name         = "SJAssetPicker_CocoaPods"
  s.version      = "1.0"
  s.summary      = "The easiest way to user picker photos."
  s.homepage     = "https://github.com/zhoushejun/SJAssetPicker_CocoaPods"
  s.license      = "MIT"
  s.author             = { "shejunzhou" => "965678322@qq.com" }
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/zhoushejun/SJAssetPicker_CocoaPods.git", :tag => s.version }
